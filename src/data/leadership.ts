...
export const leadership: Leader[] = [
  {
    ...
    bio: [
      'Shannon is an ordained pastor and the President of Ember Ridge, an auxiliary ministry of Firebrand Revivalists where she serves as the President and CEO, a biblically based ministry operating in the supernatural giftings of the Holy Spirit. She is also the Founder and President of Sophion Media and Consulting Group, a consulting business. She also serves as the President of Generational Legacy Foundation, an auxiliary and philanthropic ministry of Firebrand Revivalists. In addition, she founded and serves as the President of an auxiliary ministry called Jesus Loves the Little Children, dedicated to raising up Spirit-led chaplains who go into schools to serve families, students, and staff.',
      ...
      'She has also raised up powerful prayer movements, equipping individuals to hear the voice of God for their families, communities, and civil governing leaders. Her influence extends into the political and business arenas, where she has ministered to political leaders, advised ministry leaders, coached business owners and executives through seasons of growth and difficulty, guided companies on leadership, culture, and integrity, and helped them identify and address spiritual corruption.',
  ...
  },
  {
    ...
    bio: [
      'Jason Suttles serves as the Vice President of Ember Ridge, Firebrand Revivalists, Generational Legacy Foundation and Jesus Loves the Little Children. He is the Co-Founder and Vice President of Sophion Media and Consulting Group, a consulting business. He is the devoted husband of Shannon Suttles, and together they have two children and one grandchild.',
